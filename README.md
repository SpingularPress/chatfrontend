[![Build Status](https://travis-ci.org/Spingular/frontend.svg?branch=master)](https://travis-ci.org/Spingular/frontend)
...
To build the final jar and optimize the spingularui application for production, run:
